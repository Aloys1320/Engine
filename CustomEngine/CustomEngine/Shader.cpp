...
bool Shader::loadShaders(const char * vertexFile, const char * fragmentFile)
{
	//Load shaders
...
Shader::Shader()
{
	loadShaders("Assets/Shaders/vShader.glsl", "Assets/Shaders/fShader.glsl");
}

Shader::Shader(const char * vertPath, const char * fragPath)
{
	failStat = false;
	failStat=loadShaders(vertPath, fragPath);
}
